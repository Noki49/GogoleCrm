...
use Gogole\ContactBundle\Entity\societe;
use Gogole\ContactBundle\Form\societeType;
...
class societeController extends Controller
{
     ...
     *
     * @Route("/", name="societe_create")
     * @Method("POST")
     * @Template("GogoleContactBundle:societe:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('societe', array()));
        }
     ...
     *
     * @Route("/nouveau", name="societe_new")
     * @Method("GET")
     * @Template()
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GogoleContactBundle:societe')->find($id);
     ...
     *
     * @Route("/{id}/editer", name="societe_edit")
     * @Method("GET")
     * @Template()
     */
...
//        $form->add('submit', 'submit', array('label' => 'Update'));
     ...
     *
     * @Route("/{id}", name="societe_update")
     * @Method("PUT")
     * @Template("GogoleContactBundle:societe:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('societe', array('id' => $id)));
        }
