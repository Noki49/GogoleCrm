...
use Gogole\ContactBundle\Entity\contact;
use Gogole\ContactBundle\Form\contactType;
...
class contactController extends Controller
{
     ...
     * @Method("POST")
     * @Template("GogoleContactBundle:contact:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('contact', array()));
        }
...
//        $form->add('submit', 'submit', array('label' => 'Create'));
     ...
     *
     * @Route("/nouveau", name="contact_new")
     * @Method("GET")
     * @Template()
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GogoleContactBundle:contact')->find($id);
     ...
     *
     * @Route("/{id}/editer", name="contact_edit")
     * @Method("GET")
     * @Template()
     */
...
//        $form->add('submit', 'submit', array('label' => 'Update'));
     ...
     * @Method("PUT")
     * @Template("GogoleContactBundle:contact:edit.html.twig")
     */
